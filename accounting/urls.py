...
urlpatterns = [
    ...
    path("invoices/<str:number>/edit/",views.InvoiceUpdateView.as_view(),name="invoice_update",),
    path("invoices/<str:number>/",views.InvoiceDetailView.as_view(),name="invoice_detail",),
    path("invoices/<str:number>/payments/new/",views.InvoicePaymentCreateView.as_view(),name="invoice_add_payment",),
    path("invoices/<str:number>/print/",views.InvoicePrintView.as_view(),name="invoice_print",),
